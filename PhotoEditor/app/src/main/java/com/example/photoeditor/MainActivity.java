...
//    }
//
//    private static final int REQUEST_PERMISSONS = 1234;
...
//        if (requestCode == REQUEST_PERMISSONS && grantResults.length > 0) {
//            if (notPermissions()) {
//                Toast toast = Toast.makeText(this, "Редактор не может работать без доступа к Вашим фото. Пожалуйста, выберите 'Разрешить'", Toast.LENGTH_LONG);
//                toast.show();
...
//        }
//        final Button selectImageById = findViewById(R.id.selectImageButton);
//
//        selectImageById.setOnClickListener(new View.OnClickListener() {
//            @Override
